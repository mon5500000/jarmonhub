...
if _G.language == "ENG" then
    ...
    rtux:Button(
        "Latest Script Update: April 7th, 2024 ✅",
        function()
            DiscordLib:Notification("แจ้งเตือน", "กดเพื่อ!", "โอ้วไปละ")
        end
    )
    ...
    local unus = serv:Channel("🌐 ・ Server")
